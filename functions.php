<?php
/**
 * themanager functions and definitions
 *
...
if ( ! function_exists( 'tm_setup' ) ) :
	...
	function tm_setup() {
		 ...
		 * If you're building a theme based on themanager, use a find and replace
...
function tm_content_width() {
	...
	$GLOBALS['content_width'] = apply_filters( 'tm_content_width', 640 );
}
...
function tm_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'tm' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'tm' ),
...
function tm_scripts() {
  ...
  wp_enqueue_script( 'tm-appjs', get_template_directory_uri() . '/assets/main.min.js', array('jquery'), true );
	wp_enqueue_script( 'tm-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );
	wp_enqueue_script( 'tm-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
